...
SECRET_KEY = 'rih(brf&e_wjuo2lve7!y%$(um_)kch717+rnhm2r6mrij#usd'
...
# STATICFILES_STORAGE = 'whitenoise.storage.CompressedManifestStaticFilesStorage' # add compression
# and caching support for heroku
