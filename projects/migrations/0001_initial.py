    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', model_utils.fields.AutoCreatedField(default=django.utils.timezone.now, editable=False, verbose_name='created')),
                ('modified', model_utils.fields.AutoLastModifiedField(default=django.utils.timezone.now, editable=False, verbose_name='modified')),
                ('project_code', models.CharField(max_length=10, unique=True, verbose_name='Code')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobile_money_name', models.CharField(blank=True, max_length=30, null=True)),
                ('registered_by_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='WageSheet',
            fields=[
                ...
                ('manager_comment', models.TextField(blank=True, default='-', null=True)),
                ('project_manager_status', models.BooleanField(null=True)),
                ('project_manager_comment', models.TextField(blank=True, default='-', null=True)),
                ('gm_status', models.BooleanField(null=True)),
                ('gm_comment', models.TextField(blank=True, default='-', null=True)),
                ...
                ('segment', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='projects.segment')),
